package de.uni_koeln.spinfo.ir.test;
...
import de.uni_koeln.spinfo.ir.ir5.Corpus;
import de.uni_koeln.spinfo.ir.ir5.Document;
import de.uni_koeln.spinfo.ir.ir5.InformationRetrieval;
import de.uni_koeln.spinfo.ir.ir5.InvertedIndex;
import de.uni_koeln.spinfo.ir.ir5.Ranker;
import de.uni_koeln.spinfo.ir.ir6.Evaluation;
import de.uni_koeln.spinfo.ir.ir6.EvaluationResult;
import de.uni_koeln.spinfo.ir.ir6.GoldStandard;
...
public class TestEval {
	...
	public void evalRankedTop() {
		...
		EvaluationResult evalUnranked = evaluation.evaluate(unranked.subList(0,
				k));
		assertTrue("Evaluation der besten k sollte das Ergebnis verbessern.",
	...
	public void evalRankedMultiK() {
		...
		for (int i = K_START; i < K_END; i++) {
			EvaluationResult evalRanked = evaluation.evaluate(ranked.subList(0,
					i));
	...
	public void evalUnrankedMultiK() {
		...
		for (int i = K_START; i < K_END; i++) {
			EvaluationResult evalRanked = evaluation.evaluate(unranked.subList(
					0, i));
